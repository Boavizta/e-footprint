...
### Changed
- Sankey construction now folds the cached attribution matrix as native kg floats and reuses those fold totals for component-breakdown normalization. Pint quantities are created only at the display boundary; the general attribution fold remains quantity-valued for programmatic callers.
