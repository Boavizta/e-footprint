...
class SankeyGraph:
    ...
    def reset(self) -> None:
        ...
        self.node_total_values: list[float] = []
    ...
    def add_node(self, label: str, key: Any, color_key: str | None = None, obj: Any = None) -> int:
        ...
        self.node_total_values.append(0.0)
        if obj is not None:
    ...
    def reset_links_preserving_root_totals(self) -> list[tuple[int, int, float]]:
        ...
        root_total_values = {
            ...
            if idx not in incoming_nodes and self.node_total_values[idx] > 0
        }
        self.link_sources = []
        self.link_targets = []
        self.link_values = []
        self.link_index_by_edge = {}
        self.node_total_values = [0.0 for _ in self.node_labels]
