...
class RecurrentEdgeComponentNeed(ModelingObject):
    ...
    def unitary_hourly_need_per_usage_pattern(self, usage_pattern: "EdgeUsagePattern"):
        """Hourly resource demand for one edge device, generated by replaying the typical week over the deployment calendar and scaled by the need's containment-path count across selected bundles."""
