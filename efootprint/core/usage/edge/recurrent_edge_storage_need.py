...
class RecurrentEdgeStorageNeed(RecurrentEdgeComponentNeed):
    ...
    def unitary_hourly_need_per_usage_pattern(self, usage_pattern: "EdgeUsagePattern"):
        ...
        start_date_weekday = usage_pattern.nb_deployments_in_parallel.start_date.weekday()
        start_date_hour = usage_pattern.nb_deployments_in_parallel.start_date.hour
