...
class IntegrationTestComplexSystemFromJson(IntegrationTestComplexSystemBaseClass, metaclass=AutoTestMethodsMeta):
    """Integration tests for complex system loaded from JSON.
