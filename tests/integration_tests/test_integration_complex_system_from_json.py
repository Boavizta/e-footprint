...
class IntegrationTestComplexSystemFromJson(IntegrationTestComplexSystemBaseClass):
    ...
    def setUpClass(cls):
        system, storage_1, storage_2, storage_3, server1, server2, server3, \
            ...
            edge_storage, edge_device, edge_process, edge_usage_journey, edge_usage_pattern = cls.generate_complex_system()
        ...
        cls.system, cls.storage_1, cls.storage_2, cls.storage_3, cls.server1, cls.server2, cls.server3, \
            ...
            cls.edge_storage, cls.edge_device, cls.edge_process, cls.edge_usage_journey, cls.edge_usage_pattern = \
        ...
        flat_obj_dict[edge_storage.id], flat_obj_dict[edge_device.id], flat_obj_dict[edge_process.id], \
