...
class TestUsagePattern(unittest.TestCase):
    def setUp(self):
        ...
        self.storage = MagicMock(spec=Storage, class_as_simple_str="Storage")
        self.server = MagicMock(spec=Autoscaling, class_as_simple_str="Autoscaling")
        ...
        self.usage_pattern = UsagePattern(
            "usage_pattern", user_journey, {self.device1: 0.2, self.device2: 0.8},
            {network: 1}, {country: 1},
    ...
    def test_devices_energy(self):
        test_device1 = MagicMock(spec=Hardware, class_as_simple_str="Hardware", id="device1")
        test_device1.power = SourceValue(5 * u.W)
        test_device2 = MagicMock(spec=Hardware, class_as_simple_str="Hardware", id="device2")
    ...
    def test_devices_fabrication_footprint(self):
        device1 = MagicMock(spec=Hardware, class_as_simple_str="Hardware", id="device1")
        ...
        device2 = MagicMock(spec=Hardware, class_as_simple_str="Hardware", id="device2", name="device2")
