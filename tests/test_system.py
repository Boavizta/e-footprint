...
class TestSystem(TestCase):
    def setUp(self):
        ...
        self.usage_pattern.generated_by = None
        device = MagicMock()
        self.usage_pattern.devices = [device]
        device.systems = []
        device.generated_by = None
        self.usage_pattern.country.systems = []
        self.usage_pattern.country.generated_by = None
        self.usage_pattern.user_journey.systems = []
        self.usage_pattern.user_journey.generated_by = None
        uj_step = MagicMock()
        self.usage_pattern.user_journey.uj_steps = [uj_step]
        uj_step.systems = []
        uj_step.generated_by = None
        job = MagicMock()
        uj_step.jobs = [job]
        job.systems = []
        job.generated_by = None
        self.usage_pattern.user_journey.systems = []
        self.server = MagicMock()
        self.server.name = "server"
        self.server.systems = []
        self.server.generated_by = None
        self.storage = MagicMock()
        self.storage.name = "storage"
        self.storage.systems = []
        self.storage.generated_by = None
        self.network = MagicMock()
        self.network.name = "network"
        self.network.systems = []
        self.network.generated_by = None
