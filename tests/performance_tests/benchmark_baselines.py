...
def benchmark_load_to_ready(nb_iterations=5):
    """Parse the calculated-attributes fixture and rebuild a ready-to-use system, no recomputation."""
    ...
    for _ in range(nb_iterations):
        ...
        start = perf_counter()
        json_to_system(system_dict, launch_system_computations=False)
...
def run_benchmarks(nudge_iterations, nb_warm_builds=2):
    ...
    results["inputs_only_json_bytes"] = os.path.getsize(INPUTS_ONLY_FIXTURE)
    results["with_calc_attr_json_bytes"] = os.path.getsize(WITH_CALC_ATTR_FIXTURE)
