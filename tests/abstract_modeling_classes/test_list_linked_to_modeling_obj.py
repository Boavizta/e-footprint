...
class TestListLinkedToModelingObj(unittest.TestCase):
    ...
    def test_init(self, mock_check_value_type):
        ...
        self.mock_explainable_obj.add_obj_to_modeling_obj_containers.assert_called_with(None)
        self.assertIn(self.mock_explainable_obj2, linked_list)
        self.mock_explainable_obj2.add_obj_to_modeling_obj_containers.assert_called_with(None)
    ...
    def test_set_modeling_obj_container(self, mock_check_value_type):
        ...
        self.assertIn(self.mock_explainable_obj, linked_list)
        self.mock_explainable_obj.add_obj_to_modeling_obj_containers.assert_called_with(self.mock_modeling_obj)
        self.assertIn(self.mock_explainable_obj2, linked_list)
        self.mock_explainable_obj2.add_obj_to_modeling_obj_containers.assert_called_with(self.mock_modeling_obj)
