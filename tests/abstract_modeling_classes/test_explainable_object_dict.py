...
class TestExplainableObjectDictTriggerFlag(unittest.TestCase):
    ...
    def test_trigger_can_be_reset_to_false(self):
        d = ExplainableObjectDict()
        d.trigger_modeling_updates = True
        d.trigger_modeling_updates = False
        self.assertFalse(d.trigger_modeling_updates)
    ...
    def test_multiple_dicts_have_independent_trigger_flags(self):
        d1 = ExplainableObjectDict()
        d2 = ExplainableObjectDict()
        d1.trigger_modeling_updates = True
        self.assertTrue(d1.trigger_modeling_updates)
        self.assertFalse(d2.trigger_modeling_updates)
